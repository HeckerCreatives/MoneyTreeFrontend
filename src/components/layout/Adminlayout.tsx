'use client'
import { admin, superadmin, user } from '@/routes/route'
  ...
  return (
    ...
    >
      ...
      <div className=' relative z-40 w-full h-full hidden lg:flex items-center justify-center bg-amber-950 rounded-md '>
        ...
        >
          <header className=' sticky top-0 z-50 bg-amber-50 text-xs font-semibold w-full flex text-amber-950 items-center justify-between py-2 border-b-2 border-amber-950/20 px-4'>
