...
export default function Transferfundshistory() {
    ...
    useEffect(() => {
        ...
        const getList = async () => {
          try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/walletconversion/getwalletconversionhistory?page=${currentpage}&limit=10`,{
